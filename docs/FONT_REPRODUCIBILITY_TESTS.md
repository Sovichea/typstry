...
Run on clean Windows, Linux, and macOS virtual machines using packaged Typsastra builds.

- Export/import a Latin project with regular, bold, italic, math, and symbol faces.
- Repeat with Khmer shaping, another complex script, CJK, a variable font, a TTC collection, and a Typsastra-generated scaled font.
